...
import { Home, Collections, Prices, Settings, Camera } from "./screens";
...
import FunCamera from './components/FunCamera.js';
              ...
              return (
                <View style={{alignItems: "center", justifyContent: "center"}}> 
                 <Entypo name="wallet" size={24} color={focused ? "#16247d": "#111"} />
                  <Text style={{fonSize: 12, color: "#16247d"}}>Collections</Text>
            </View>
              )
            }
          }}
